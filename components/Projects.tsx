                ...
                {projects.map((project, i) => (
                    <div className="w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen">
                        <motion.img
                            ...
                            // viewport={{ once: true }}
                            src="https://i.ibb.co/D8G7vWF/Untitled-design.png"
                            alt=""
                        />
                        ...
                        <div className="space-y-10 px-0 md:px-10 max-w-6xl">
                            ...
                            <p className="text-lg text-center md:text-left">
                                ...
                                tristique senectus et netus et. Magnis dis
                                parturient montes nascetur ridiculus mus mauris.
                                Ullamcorper sit amet risus nullam eget. Ornare
                                quam viverra orci sagittis eu. Orci eu lobortis
